...
module IntIntDictionary = TreeDictionary.Make(Int)(Int);;
...
(* If you evaluate [d], you will note that utop prints it
   as "<unimplemented>".  After completing [ListDictionary.format] 
   you will get more helpful output. *)
let d = empty;;
